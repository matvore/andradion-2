// CompactMap.h: interface for the CCompactMap class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_COMPACTMAP_H__15C72425_5E64_11D4_B6FE_0050040B0541__INCLUDED_)
#define AFX_COMPACTMAP_H__15C72425_5E64_11D4_B6FE_0050040B0541__INCLUDED_
...
namespace NGameLib2
{
	...
	public:
		...
		// uses direct draw clippers and Blt, clipper should already be attatched to surface,
		//  otherwise, no clipping will happen!
		// pass:  target surface, target x, target y, true to blit asynchronously
		...
		//  no clipping
		void RenderStep2(void *surface,int pitch,int x,int y,const RECT *simple_clipper_rect); 
	...
	{
		assert(true == this->Certified() || !"Tried to check for empty compact map when it was not certified!");

		return this->patterns.empty() && this->blocks.empty() && this->left_over.empty();
	}

	inline bool CCompactMap::NoStep1() const
	{
		assert(true == this->Certified() || !"Tried to check for empty step 1 when compact map was not certified");
	...
	{
		assert(true == this->Certified() || !"Tried to check for empty step 2 when compact map was not certified");

		return this->left_over.empty();
	}
} // end namespace

#endif // !defined(AFX_COMPACTMAP_H__15C72425_5E64_11D4_B6FE_0050040B0541__INCLUDED_)
