...
const int MAX_SOUNDS = 15; // maximum of five sounds at a time
...
// these are the profile names, only used in debugging mode
enum {Main_Game_Loop,Sound_Loop,Recaching,Enemy_Logic,Hero_Logic,Draw_Things,Draw_Character,U_Cmp_Drawing_N_Weather,Weather_One_Frame,Draw_Extra_Stats_N_Msgs,L_Cmp_Drawing,Draw_Meters,NUM_PROFILES};
