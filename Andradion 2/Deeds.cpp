// Accomplishments.cpp: implementation of the CAccomplishments class.
//
//////////////////////////////////////////////////////////////////////
...
void DeeLevelComplete(FIXEDNUM since_start,int score,int next_level)
{
  ...
  if((const)best_times[level].first == time)
    {
  ...
  if((const)best_scores[level].first == score)
    {
...
void DeeGetLevelAccomplishments(tstring *lines)
{
